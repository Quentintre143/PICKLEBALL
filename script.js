document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    // Mise à jour locale des statistiques avant l'envoi natif du formulaire
    // (le navigateur va ensuite soumettre le formulaire directement à Formspree
    // via l'attribut action="https://formspree.io/f/xlgqrkye" et quitter la page)
    ...
    // Pas de e.preventDefault() ici : le formulaire s'envoie normalement à Formspree
  });
